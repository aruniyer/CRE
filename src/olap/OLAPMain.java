...
public class OLAPMain {
	...
	public static Instances getInstances(String file, String type)
			throws Exception {
	...
	public static File createTraining(Instances instances, String outputDir,
			String outputFilePrefix, SortedSet<Integer> attributes,
			int countPerClass) throws Exception {
		...
		String outputFileFullPrefix = outputDir + File.separatorChar
				+ outputFilePrefix;
		File file = new File(outputFileFullPrefix + "." + attributeString
				+ "_train");
	...
	public static void main1(String[] args) throws Exception {
		...
		List<File> groupFiles = GroupBy.doGroup(instances, groupDir,
				groupFilePrefix, valueMap);

		// Create training data
		File trainingFile = createTraining(instances, trainingDir,
				trainingFilePrefix, new TreeSet<Integer>(valueMap.keySet()),
				100);
